...
The ConfigCat SDK team monitors the [issue tracker](https://github.com/configcat/go-sdk/issues) in the SDK repository. Bug reports and feature requests specific to this SDK should be filed in this issue tracker. The team will respond to all newly filed issues.
